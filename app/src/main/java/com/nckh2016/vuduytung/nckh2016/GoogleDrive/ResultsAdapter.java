        ...
        btnXoa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(mContext)
                        .setTitle("Xóa")
                        .setMessage("Xóa tệp sao lưu có mã sinh viên " + metadata.getTitle().replace(PATTERN, "") + "?")
                        .setIcon(R.drawable.error)
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                fragment2.deleteFile(metadata);
                                dialog.dismiss();
                            }
                        })
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder(mContext)
                        ...
                        .setMessage("Việc khôi phục dữ liệu sẽ ghi đè lên hồ sơ có mã sinh viên " + metadata.getTitle().replace(PATTERN, "") + ", tiếp tục?")
