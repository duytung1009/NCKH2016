    ...
    private class MainTask extends AsyncTask<Void, Long, ArrayList<Object>> {
        ...
        protected void onPostExecute(ArrayList<Object> objects) {
            ...
            if(objects.size() == 0){
                ...
                monHocAdapter = new AdapterXoaMonHoc(getActivity(), 0);
                    ...
                    new AlertDialog.Builder(getContext())
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if (flag) {
                                        SharedPreferences currentUserData = mContext.getSharedPreferences(Utils.PREFS_NAME, Context.MODE_PRIVATE);
                                        SharedPreferences.Editor editor = currentUserData.edit();
                                        editor.putString(Utils.SUB_PREFS_DATASINHVIEN, new Gson().toJson(userData));
                                        editor.apply();
